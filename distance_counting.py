...
def distance_plots(dst_l, dst_r, dst_dic, time):
    if dst_r is not None:
        ...
        plot_l_apart.set_xlabel('Time [s]')
        plot_l_apart.set_ylabel('Distance')
        ...
        plot_r_apart.set_xlabel('Time [s]')
        plot_r_apart.set_ylabel('Distance')
        ...
        plot_all.set_xlabel('Time [s]')
        plot_all.set_ylabel('Distance')
